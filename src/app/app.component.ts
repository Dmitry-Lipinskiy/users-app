...
import { IAlbum, IPost, ITodo, IUser } from './shared/model/user-app.model';
...
export class AppComponent implements OnInit {
  ...
  getPosts(id: number): void {
    ...
    this.userService.getPostsById(id).subscribe((posts: IPost[]) => {
      this.posts = posts;
    })
  }
  ...
  getAlbums(userId: number) {
    ...
    this.userService.getAlbumsByUserId(userId).subscribe((albums: IAlbum[]) => {
      this.albums = albums;
    })
  }
